                    ...
                    <div class="col-md-12 col-lg-4 mb-4">
                        <div class="card timeline shadow">
                            ...
                            <div class="card-body" data-simplebar
                                style="height:345px; overflow-y: auto; overflow-x: hidden;">
                                <div class="pb-3 timeline-item item-primary">
                                    <div class="pl-5">
                                        <div class="mb-1 small"><span>@Brown Asher</span><span
                                                class="text-muted mx-1">Just create new layout Index, form,
                                                table</span><span>Tinydash</span></div>
                                        <p class="small text-muted">Creative Design
                                            <span class="badge bg-light">1h ago</span>
                                        </p>
                                    </div>
                                </div>
                                <div class="pb-3 timeline-item item-info">
                                    <div class="pl-5">
                                        <div class="mb-3 small"><span>@Fletcher Everett</span><span
                                                class="text-muted mx-1">created new group for</span><span>Tinydash</span>
                                        </div>
                                        ...
                                        <p class="small text-muted">Front-End Development
                                            <span class="badge bg-light">1h ago</span>
                                        </p>
                                    </div>
                                </div>
                                <div class="pb-0 timeline-item item-success">
                                    <div class="pl-5">
                                        <div class="mb-2 small"><span>@Kelley Sonya</span><span
                                                class="text-muted mx-1">has commented on</span><span>Advanced table</span>
                                        </div>
                                        ...
                                        <p class="small text-muted mb-0">Back-End Development
                                            <span class="badge bg-light">1h ago</span>
                                        </p>
                                    </div>
                                </div>
